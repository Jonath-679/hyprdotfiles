...
hl.workspace_rule({workspace="6", monitor=monitorExterno})
hl.workspace_rule({workspace="7", monitor=monitorExterno})
hl.workspace_rule({workspace="8", monitor=monitorExterno})
hl.workspace_rule({workspace="9", monitor=monitorExterno})
hl.workspace_rule({workspace="10", monitor=monitorExterno})
